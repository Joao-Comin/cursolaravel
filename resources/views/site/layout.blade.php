    ...
    <nav class="red">
        <div class="nav-wrapper container">
            ...
            <ul id="nav-mobile" class="left">
                ...
                <li><a href="{{ route('site.carrinho') }}">Carrinho <span class="new badge blue"
            ...
            @auth
                <ul id="nav-mobile" class="right">
                    <li><a href="" class="dropdown-trigger" data-target='dropdown2'>Olá
                            {{ auth()->user()->firstName }} <i class="material-icons right">arrow_drop_down</i></a></li>
                </ul>
            @else
                <ul id="nav-mobile" class="right">
                    <li><a href="{{route('login.form')}}">Login<i
